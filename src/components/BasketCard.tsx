...
export const BasketCard = ({ data }: IProps) => {
    ...
    <div className='hover:border-1 flex h-[218px] w-[633px] items-center rounded-[30px] border bg-white px-5 py-2'>
      <div className='flex-col'>
        ...
        <div className='mt-5 flex w-full items-center justify-between'>
          ...
          <span className='text-lg font-[600]'>1</span>
      ...
      <div className='ml-6 flex-grow flex-col pb-6'>
        ...
        <span className='text-sm font-[500] text-[#838383]'>{price} ₽</span>
      </div>
      ...
      <div className='flex h-full flex-col justify-between'>
        ...
        <div className='mb-2 text-sm font-[600]'>{price} ₽</div>
      </div>
    </div>
  )
}
